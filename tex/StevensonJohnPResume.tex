...
\begin{resumesection}{EXPERIENCE}
    ...
    {Intel}
    {2014 -- Present}
    {Santa Clara, CA, Silicon Architect}
    \myitem{Continued to develop next generation memory technology as a member of the HICAMP team acquired in 2014.
    ...
    \myitem{As member of a seven person team, all engineers, contributed to proof of concept implementation
            of next generation CPU memory in FPGA. Technology acquired by Intel in 2014.}
