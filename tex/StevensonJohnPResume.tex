...
\begin{resumesection}{EXPERIENCE}
    ...
    \myitem{
        PAX is a new crypto exchange, on a chip. % with world's fastest tick-to-trade.
    ...
    \myitem{
        ...
        % Implemented record \& replay test \& development feature.
    }
    ...
    % \myitem{Depth recovery algorithms for non-stereoscopic images.}
