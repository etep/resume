...
% -- original template -- \hrule
% -- original template -- \vspace{-0.4em}
% -- original template -- \subsection*{Core Technical Skills}
% -- original template -- 
% -- original template -- \begin{indentsection}{\parindent}
% -- original template -- \hyphenpenalty=1000
% -- original template -- \begin{description*}
% -- original template -- 	\item[Languages:]
% -- original template -- 	C, \CPP, Java, JavaScript, \LaTeX, Perl, Python, shell script, SQL
% -- original template -- 	\item[Open Source Contributions:]
% -- original template -- 	Project A, Project B, Project C
% -- original template -- \end{description*}
% -- original template -- \end{indentsection}
